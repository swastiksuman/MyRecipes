package com.spring.recipeweb.bootstrap;
...
import com.spring.recipeweb.domain.Difficulty;
import com.spring.recipeweb.domain.Ingredient;
import com.spring.recipeweb.domain.Notes;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Ingredient i = new Ingredient("ripe avocados", new BigDecimal(1), eachUom);
        guacRecipe.addIngredient(i);
        guacRecipe.addIngredient(new Ingredient("Kosher salt", new BigDecimal(".5"), teapoonUom));
        guacRecipe.addIngredient(new Ingredient("fresh lime juice or lemon juice", new BigDecimal("2.0"), tableSpoonUom));
        guacRecipe.addIngredient(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(1), tableSpoonUom));
